...
<div class="flex flex-wrap gap-4 px-4 pt-6 pb-4 shadow-sm lg:hidden">
    ...
    <form action="{{ route('shop.search.index') }}" class="flex items-center w-full">
        ...
        <div class="relative w-full">
            ...
            <input
                type="text"
                class="block w-full rounded-xl border border-zinc-300 bg-zinc-100 px-11 py-3.5 text-sm font-medium text-gray-900 max-md:rounded-lg max-md:px-10 max-md:py-3 max-md:font-normal max-sm:text-xs"
                name="query"
                value="{{ request('query') }}"
